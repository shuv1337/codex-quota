/**
 * All configuration constants for shuvquota.
...
// CLI command names
export const PRIMARY_CMD = "shuvquota";
export const SHUVQUOTA_LABEL_KEY = "shuvquota_label";
export const LEGACY_CODEX_QUOTA_LABEL_KEY = "codex_quota_label";
